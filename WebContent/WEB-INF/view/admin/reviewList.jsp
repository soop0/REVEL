                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">
                            	<c:if test="${theme != 'clean'}">
                            		댓글 리스트
                            	</c:if>
                            	<c:if test="${theme eq 'clean'}">
                            		클린봇 삭제 댓글 리스트
                            	</c:if>
                            </h6>
                        </div>
                                    	...
                                    	<thead align="center">
                                       	...
                                       	<tbody align="center">
                                    		<c:forEach var="review" items="${reviewList}">
                                        		<tr>
                                            		<td>${review.index_review}</td>
                                            		<td>${review.nick}</td>
                                            		<td>${review.title}</td>
                                            		<td>
                                            			<c:if test="${theme != 'clean'}">
                                            				<c:if test="${review.cleanbot == 0}">
                                            					${review.content}
                                            				</c:if>
                                            				<c:if test="${review.cleanbot > 0}">
                                            		...
                                            		<td><fmt:formatDate value="${review.reg_time}" pattern="yyyy-MM-dd HH:mm"/></td>
                                            		<td>
                                            			<a href="/revel/manage/board/reviewDel.rv?reviewNum=${review.index_review}&bookNum=${review.index_book}" 
                                            			   class="btn btn-danger btn-circle btn-sm" onclick="return reviewDel();">
