...
<%-- 
	revel 웹소설 인기차트 목록 페이지(남성/여성 Top5 차트)
	http://localhost:8080/revel/manage/analysis/novel/best.rv 
...
<head>
 ...
 <body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Top5 인기 차트</h1>
                    <p class="mb-4">성별 Top5 인기소설 순위 차트</p>
                    	 ...
                    	 <div class="col-xl-8 col-lg-7">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">남성 인기소설 Top5</h6>
                                </div>
                                <div class="card-body">
                                	<div class="chart-bar" style="height:100%">
                                    	<canvas id="manBestChart"></canvas>
                                    </div>
                                    <hr>
                                    	<c:if test="${count > 0}">
                                    		<p align="center">남성 회원 중 가장 인기 많은 소설 Top5를 확인할 수 있습니다.</p>
                                    	</c:if>
                                    	<c:if test="${count == 0}">
                                    		<p align="center">인기 순위를 확인할 수 없습니다.</p>
                                    	</c:if>
                                	</div>
                            </div>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">여성 인기소설 Top5</h6>
                                </div>
                                <c:if test="${count > 0}">
                                	<div class="card-body">
                                    	<div class="chart-bar" style="height:100%">
                                        	<canvas id="womanBestChart"></canvas>
                                    	</div>
                                    	<hr>
                                    		<p align="center">여성 회원 중 가장 인기 많은 소설 Top5를 확인할 수 있습니다.</p>
                                	</div>
                                </c:if>
                                <c:if test="${count == 0}">
                                	<div class="card-body">
    ...
    <script src="/revel/resources/js/demo/datatables-demo.js"></script>
 	 ...
 	 <!-- 소재 키워드 Top5 그래프 그리기 -->
    <script type="text/javascript">
    	var context=document.getElementById('manBestChart');
    	
    	// 차트 데이터
    	var chartData = {
    		labels:['${manBest[0].title}','${manBest[1].title}','${manBest[2].title}','${manBest[3].title}','${manBest[4].title}'],
    		datasets:[{
    			label : '링크클릭횟수',
    			data:[${manBest[0].total},${manBest[1].total},${manBest[2].total},${manBest[3].total},${manBest[4].total}],
    ...
    <!-- 여성회원 인기소설 Top5 그래프 그리기 -->
    <script type="text/javascript">
    	var context=document.getElementById('womanBestChart');
    	
    	// 차트 데이터
    	var chartData = {
    		labels:['${womanBest[0].title}','${womanBest[1].title}','${womanBest[2].title}','${womanBest[3].title}','${womanBest[4].title}'],
    		datasets:[{
    			label : '누적점수',
    			data:[${womanBest[0].total},${womanBest[1].total},${womanBest[2].total},${womanBest[3].total},${womanBest[4].total}],
    			backgroundColor: ['#e74a3b','#f6c23e','#1cc88a','#4e73df','#858796'],
    			borderColor:['#e74a3b','#f6c23e','#1cc88a','#4e73df','#858796'],
    			borderWidth:1
    		}]	
