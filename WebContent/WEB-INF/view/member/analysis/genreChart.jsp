        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <!-- 해당 페이지 이름 -->
                    <h1 class="h3 mb-2 text-gray-800">My Genre Analysis</h1>

                    <!-- DataTales Example -->
                    <!-- 나의 선호 장르 분석 차트 -->
                 	<div class="card shadow mb-4">
						<div class="card-header">
                            <h6 class="m-0 font-weight-bold text-primary">나의 선호 장르 분석 차트</h6>
						</div>
                  ...
                  <div class="card shadow mb-4">
						<div class="card-header">
                            <h6 class="m-0 font-weight-bold text-primary">나의 장르별 댓글 분석 차트</h6>
						</div>
                   		<div class="card-body">
							<!--차트가 그려질 부분-->
	                       	<div class="chart"  align="center">
								<canvas id="myReview_horizontalBar"></canvas>
							</div><br /><br />
				  		 </div>
				  </div>
                <!-- /.container-fluid -->
