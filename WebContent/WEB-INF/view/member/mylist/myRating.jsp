        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <!-- 해당 페이지 이름 -->
                    <h1 class="h3 mb-2 text-gray-800">My Rating</h1>

                    <!-- DataTales Example -->
                    <!-- 나의 작품 평가 목록 테이블 -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">나의 작품 평가 목록</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                            	<!-- count가 0이면 내가 평가한 작품 목록이 없다. -->
                            	<c:if test="${count == 0}">
                            		<p align="center">내가 평가한 작품이 없습니다</p>
                            	</c:if>
                            	
                            	<!-- count가 1이상이면 평가한 작품 목록을 보여준다. -->
                            	<c:if test="${count > 0}">	
                                	<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    	...
                                    	<tbody align="center">
                                    		<c:forEach var="rating" items="${ratingDetail}">
                                        		<tr>
                                            		<td>
                                            			${count}
                                            		...
                                            		<td>
                                            			<a href="/revel/detail.rv?bookNum=${rating.index_book}">
                                            				${rating.title}
                                            			</a>
                                            		</td>
                                            		<td>${rating.writer}</td>
                                            		<td>${rating.rating}</td>
                                            		<td>
                                            			<fmt:formatDate value="${rating.reg_time}" pattern="yyyy-MM-dd HH:mm" />
                                            		</td>                		
                                            		<td>
                                            			<a href="/revel/mypage/ratingDel.rv?memberNum=${rating.index_member}&bookNum=${rating.index_book}" 
                                            			   class="btn btn-danger btn-circle btn-sm" onclick="return myRatingDel();">
                                ...
                                <!-- 삭제 최종확인 알림창 -->
                                <script type="text/javascript">
                                	function myRatingDel()
                                	{
                                		var msg = confirm("평점을 삭제하시겠습니까?");
                                		if(msg)
                                		{
                                			// yes
                                			widow.location = "/revel/mypage/ratingDel.rv";
                                		}
                                		else
                                		{
                                			// no
